...
import com.example.jacciik.mytaomaoduobao.Utils.CommonUtil;
...
public class RetrofitHelper {
    ...
    public static GetTbkItemService getTaoMaoAPI() {
        return createApi(GetTbkItemService.class, ConstantUtil.BASE_URL);
    }
    ...
    private static void initOkHttpClient() {
        ...
        if (mOkHttpClient == null) {
            synchronized (RetrofitHelper.class) {
                //设置Http缓存
                Cache cache = new Cache(new File(TaoMaoDuoBaoApp.getInstance()
   ...
   /* */
    ...
    private static class CacheInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (CommonUtil.isNetworkAvailable(TaoMaoDuoBaoApp.getInstance())) {
                //有网络时只从网络获取

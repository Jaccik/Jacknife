...
import com.example.jacciik.mytaomaoduobao.Bean.MainDomain;
...
public interface GetTbkItemService {
    ...
    * */
    ...
    Observable<AliUpdateBean> updateAccount(@Query("id") String id, @Query("name") String name, @Query("nick") String nick);

    @GET("getVersion/version")
    Observable<VersionBean> getAppVersion();


    @GET("import/getBanner")
    Observable<MainDomain> getBannerData();

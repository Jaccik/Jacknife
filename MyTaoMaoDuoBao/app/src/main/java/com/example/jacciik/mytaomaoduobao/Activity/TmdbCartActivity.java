...
import com.example.jacciik.mytaomaoduobao.Activity.BaseActivity;
...
public class TmdbCartActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //在当前的webview中打开购物车
        AlibcTrade.show(this, web_view, null, null, alibcBasePage, alibcShowParams, null, exParams, new DemoTradeCallback());
    }

    @Override
    public int getLayoutId() {
        return R.layout.tmdb_activity_cart;
    }
